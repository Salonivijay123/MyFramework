...
class BasePage:
    ...
    def slide_with_keyboard(self, handle_element, direction: str, press_count: int):
        self.move_to_element(handle_element)
        key_to_press = Keys.ARROW_RIGHT if direction.lower() == "right" else Keys.ARROW_LEFT
        for _ in range(press_count):
            handle_element.send_keys(key_to_press)
